...
def define_G(input_nc, output_nc, ngf, which_model_netG, norm='batch', use_dropout=False, init_type='normal', gpu_ids=[]):
    ...
    if which_model_netG == 'resnet_9blocks':
        ...
        netG = UnetGeneratorBetterUpsampler(input_nc, output_nc, 5, ngf, norm_layer=norm_layer, use_dropout=use_dropout, gpu_ids=gpu_ids)
...
class Pix2PixModel(nn.Module):
	def __init__(self, output_nc, input_nc=3, arch='unet_256'):
		super(Pix2PixModel, self).__init__()

		self.netG = define_G(input_nc, output_nc, 64, arch, 'batch', False, 'xavier', [0])
